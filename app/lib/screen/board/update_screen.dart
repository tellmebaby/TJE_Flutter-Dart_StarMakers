...
//     _titleController = TextEditingController(text: board.title);
//     _writerController = TextEditingController(text: board.writer);
//     _contentController = TextEditingController(text: board.content);
//   }

//   Future<void> _updateBoard(Board board) async {
...
//     if (response.statusCode == 200) {
//       Navigator.pop(context, true); // 업데이트 후 이전 화면으로 돌아가기
//     } else {
//       ScaffoldMessenger.of(context).showSnackBar(
